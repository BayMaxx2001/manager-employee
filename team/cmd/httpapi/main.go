...
import (
	...
	"github.com/BayMaxx2001/manager-employee/team/internal/app/httpapi"
	"github.com/BayMaxx2001/manager-employee/team/internal/app/terminal"
	"github.com/urfave/cli/v2"
)

func main() {
	app := cli.NewApp()
	app.Name = "Team micro service"
	app.Usage = "Team micro service"
